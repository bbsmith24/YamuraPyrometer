  ...
  Serial.println("server.on handler");
    ...
    for (int i = 0; i < params; i++) {
      ...
      if (strcmp(p->name().c_str(), "fontsize_id") == 0) {
        ...
        if ((tempDevice.fontPoints != 9) && (tempDevice.fontPoints != 12) && (tempDevice.fontPoints != 18) && (tempDevice.fontPoints != 24)) {
...
void MainMenu() {
  ...
  mainMenuChoices[0].description = "Measure Temps";
  mainMenuChoices[0].result = MEASURE_TIRES;
  mainMenuChoices[1].description = cars[selectedCar].carName;
  mainMenuChoices[1].result = SELECT_CAR;
  mainMenuChoices[2].description = "Display Temps";
  mainMenuChoices[2].result = DISPLAY_TIRES;
  mainMenuChoices[3].description = "Instant Temp";
  mainMenuChoices[3].result = INSTANT_TEMP;
  mainMenuChoices[4].description = "Display Selected Results";
  mainMenuChoices[4].result = DISPLAY_SELECTED_RESULT;
...
void ChangeSettingsMenu() {
  ...
  while (true) {
    settingsChoices[SET_DATETIME].description = "Set Date/Time";
    settingsChoices[SET_DATETIME].result = SET_DATETIME;
    settingsChoices[SET_TEMPUNITS].description = "Set Units";
    settingsChoices[SET_TEMPUNITS].result = SET_TEMPUNITS;
    // flip display and buttons
    if (deviceSettings.screenRotation == 1) {
      settingsChoices[SET_FLIPDISPLAY].description = "Switch to Left Hand (invert screen)";
      settingsChoices[SET_FLIPDISPLAY].result = SET_FLIPDISPLAY;
    } else if (deviceSettings.screenRotation == 0) {
      settingsChoices[SET_FLIPDISPLAY].description = "Switch to Right Hand (invert screen)";
      settingsChoices[SET_FLIPDISPLAY].result = SET_FLIPDISPLAY;
    }
    // font size
...
void Select12or24Menu() {
  ...
  hour12_24Choices[HOURS_12].description = "12 Hour clock";
  hour12_24Choices[HOURS_12].result = HOURS_12;
  hour12_24Choices[HOURS_24].description = "24 Hour clock";
  hour12_24Choices[HOURS_24].result = HOURS_24;
...
void SelectFontSizeMenu() {
  ...
  fontSizeChoices[FONTSIZE_9].description = "9 point";
  fontSizeChoices[FONTSIZE_9].result = FONTSIZE_9;
  fontSizeChoices[FONTSIZE_12].description = "12 point";
  fontSizeChoices[FONTSIZE_12].result = FONTSIZE_12;
  fontSizeChoices[FONTSIZE_18].description = "18 point";
  fontSizeChoices[FONTSIZE_18].result = FONTSIZE_18;
  fontSizeChoices[FONTSIZE_24].description = "24 point";
  fontSizeChoices[FONTSIZE_24].result = FONTSIZE_24;
...
void SetUnitsMenu() {
  ...
  unitsChoices[0].description = "Temp in F";
  unitsChoices[0].result = 0;
  unitsChoices[1].description = "Temp in C";
  unitsChoices[1].result = 1;
...
void DeleteDataFilesMenu(bool verify) {
  ...
  if (verify) {
    int menuCount = 2;
    deleteFileYN[0].description = "Yes";
    deleteFileYN[0].result = 1;
    deleteFileYN[1].description = "No";
    deleteFileYN[1].result = 0;
...
void SetDateTime() {
  ...
  while (true) {
    ...
    if ((deviceSettings.is12Hour && (setIdx >= 7)) || (!deviceSettings.is12Hour && (setIdx >= 6))) {
      break;
    }
...
void SetupTireMeasureGrid(int fontHeight) {
  ...
  // at y =
  gridLineH[0][0][0] = 1;
  gridLineH[0][0][1] = gridHeight + 10;
  gridLineH[0][1][0] = 475;
  gridLineH[0][1][1] = gridHeight + 10;

  gridLineH[1][0][0] = 1;
  gridLineH[1][0][1] = gridHeight + 80;
  gridLineH[1][1][0] = 475;
  gridLineH[1][1][1] = gridHeight + 80;

  gridLineH[2][0][0] = 1;
  gridLineH[2][0][1] = gridHeight + 150;
  gridLineH[2][1][0] = 475;
  gridLineH[2][1][1] = gridHeight + 150;

  gridLineH[3][0][0] = 1;
  gridLineH[3][0][1] = gridHeight + 220;
  gridLineH[3][1][0] = 475;
  gridLineH[3][1][1] = gridHeight + 220;
  ...
  // 475
  gridLineV[0][0][0] = 1;
  gridLineV[0][0][1] = gridHeight + 10;
  gridLineV[0][1][0] = 1;
  gridLineV[0][1][1] = gridHeight + 220;
  gridLineV[1][0][0] = 237;
  gridLineV[1][0][1] = gridHeight + 10;
  gridLineV[1][1][0] = 237;
  gridLineV[1][1][1] = gridHeight + 220;
  gridLineV[2][0][0] = 475;
  gridLineV[2][0][1] = gridHeight + 10;
  gridLineV[2][1][0] = 475;
  gridLineV[2][1][1] = gridHeight + 220;
  // V               V               V
  // 0               1               2
  // ==G0===============G1============  H0
  ...
  // grid row 0
  // cell row 0
  cellPoint[0][0][0] = gridLineV[0][0][0] + 5;
  cellPoint[0][0][1] = gridLineH[0][0][1] + 5;
  cellPoint[0][1][0] = gridLineV[0][0][0] + 75;
  cellPoint[0][1][1] = gridLineH[0][0][1] + 5;
  cellPoint[0][2][0] = gridLineV[0][0][0] + 145;
  cellPoint[0][2][1] = gridLineH[0][0][1] + 5;
  cellPoint[0][3][0] = gridLineV[1][0][0] + 145;
  cellPoint[0][3][1] = gridLineH[0][0][1] + 5;
  cellPoint[0][4][0] = gridLineV[1][0][0] + 75;
  cellPoint[0][4][1] = gridLineH[0][0][1] + 5;
  cellPoint[0][5][0] = gridLineV[1][0][0] + 5;
  cellPoint[0][5][1] = gridLineH[0][0][1] + 5;
  // cell row 1
  cellPoint[1][0][0] = gridLineV[0][0][0] + 5;
  cellPoint[1][0][1] = gridLineH[0][0][1] + gridHeight + 5;
  cellPoint[1][1][0] = gridLineV[0][0][0] + 75;
  cellPoint[1][1][1] = gridLineH[0][0][1] + gridHeight + 5;
  cellPoint[1][2][0] = gridLineV[0][0][0] + 145;
  cellPoint[1][2][1] = gridLineH[0][0][1] + gridHeight + 5;
  cellPoint[1][3][0] = gridLineV[1][0][0] + 145;
  cellPoint[1][3][1] = gridLineH[0][0][1] + gridHeight + 5;
  cellPoint[1][4][0] = gridLineV[1][0][0] + 75;
  cellPoint[1][4][1] = gridLineH[0][0][1] + gridHeight + 5;
  cellPoint[1][5][0] = gridLineV[1][0][0] + 5;
  cellPoint[1][5][1] = gridLineH[0][0][1] + gridHeight + 5;
  // grid row 1
  // cell row 2
  cellPoint[2][0][0] = gridLineV[0][0][0] + 5;
  cellPoint[2][0][1] = gridLineH[1][0][1] + 5;
  cellPoint[2][1][0] = gridLineV[0][0][0] + 75;
  cellPoint[2][1][1] = gridLineH[1][0][1] + 5;
  cellPoint[2][2][0] = gridLineV[0][0][0] + 145;
  cellPoint[2][2][1] = gridLineH[1][0][1] + 5;
  cellPoint[2][3][0] = gridLineV[1][0][0] + 145;
  cellPoint[2][3][1] = gridLineH[1][0][1] + 5;
  cellPoint[2][4][0] = gridLineV[1][0][0] + 75;
  cellPoint[2][4][1] = gridLineH[1][0][1] + 5;
  cellPoint[2][5][0] = gridLineV[1][0][0] + 5;
  cellPoint[2][5][1] = gridLineH[1][0][1] + 5;
  // cell row 3
  cellPoint[3][0][0] = gridLineV[0][0][0] + 5;
  cellPoint[3][0][1] = gridLineH[1][0][1] + gridHeight + 5;
  cellPoint[3][1][0] = gridLineV[0][0][0] + 75;
  cellPoint[3][1][1] = gridLineH[1][0][1] + gridHeight + 5;
  cellPoint[3][2][0] = gridLineV[0][0][0] + 145;
  cellPoint[3][2][1] = gridLineH[1][0][1] + gridHeight + 5;
  cellPoint[3][3][0] = gridLineV[1][0][0] + 145;
  cellPoint[3][3][1] = gridLineH[1][0][1] + gridHeight + 5;
  cellPoint[3][4][0] = gridLineV[1][0][0] + 75;
  cellPoint[3][4][1] = gridLineH[1][0][1] + gridHeight + 5;
  cellPoint[3][5][0] = gridLineV[1][0][0] + 5;
  cellPoint[3][5][1] = gridLineH[1][0][1] + gridHeight + 5;
  // grid row 2
  // cell row 4
  cellPoint[4][0][0] = gridLineV[0][0][0] + 5;
  cellPoint[4][0][1] = gridLineH[2][0][1] + 5;
  cellPoint[4][1][0] = gridLineV[0][0][0] + 75;
  cellPoint[4][1][1] = gridLineH[2][0][1] + 5;
  cellPoint[4][2][0] = gridLineV[0][0][0] + 145;
  cellPoint[4][2][1] = gridLineH[2][0][1] + 5;
  cellPoint[4][3][0] = gridLineV[1][0][0] + 145;
  cellPoint[4][3][1] = gridLineH[2][0][1] + 5;
  cellPoint[4][4][0] = gridLineV[1][0][0] + 75;
  cellPoint[4][4][1] = gridLineH[2][0][1] + 5;
  cellPoint[4][5][0] = gridLineV[1][0][0] + 5;
  cellPoint[4][5][1] = gridLineH[2][0][1] + 5;
  // cell row 5
  cellPoint[5][0][0] = gridLineV[0][0][0] + 5;
  cellPoint[5][0][1] = gridLineH[2][0][1] + gridHeight + 5;
  cellPoint[5][1][0] = gridLineV[0][0][0] + 75;
  cellPoint[5][1][1] = gridLineH[2][0][1] + gridHeight + 5;
  cellPoint[5][2][0] = gridLineV[0][0][0] + 145;
  cellPoint[5][2][1] = gridLineH[2][0][1] + gridHeight + 5;
  cellPoint[5][3][0] = gridLineV[1][0][0] + 145;
  cellPoint[5][3][1] = gridLineH[2][0][1] + gridHeight + 5;
  cellPoint[5][4][0] = gridLineV[1][0][0] + 75;
  cellPoint[5][4][1] = gridLineH[2][0][1] + gridHeight + 5;
  cellPoint[5][5][0] = gridLineV[1][0][0] + 5;
  cellPoint[5][5][1] = gridLineH[2][0][1] + gridHeight + 5;
  // cell row 6
  cellPoint[6][0][0] = gridLineV[0][0][0] + 5;
  cellPoint[6][0][1] = gridLineH[3][0][1] + gridHeight + 10;
  cellPoint[6][1][0] = gridLineV[0][0][0] + 75;
  cellPoint[6][1][1] = gridLineH[3][0][1] + gridHeight + 10;
  cellPoint[6][2][0] = gridLineV[0][0][0] + 145;
  cellPoint[6][2][1] = gridLineH[3][0][1] + gridHeight + 10;
  cellPoint[6][3][0] = gridLineV[1][0][0] + 145;
  cellPoint[6][3][1] = gridLineH[3][0][1] + gridHeight + 10;
  cellPoint[6][4][0] = gridLineV[1][0][0] + 75;
  cellPoint[6][4][1] = gridLineH[3][0][1] + gridHeight + 10;
  cellPoint[6][5][0] = gridLineV[1][0][0] + 5;
  cellPoint[6][5][1] = gridLineH[3][0][1] + gridHeight + 10;
...
float GetStableTemp(int positionIdx, int row, int col) {
  ...
  while (true) {
    ...
    if (((minMax[1] - minMax[0]) >= deviceSettings.stableBand[0]) && ((minMax[1] - minMax[0]) <= deviceSettings.stableBand[1])) {
      break;
    }
